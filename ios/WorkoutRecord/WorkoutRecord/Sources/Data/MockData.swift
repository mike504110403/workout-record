...
struct MockData {
    ...
    static let legExercises: [Exercise] = {
        ...
        return [
            Exercise(name: "深蹲", nameEn: "Squat", categoryId: categoryId, type: .freeWeight, muscleGroups: ["股四頭肌", "臀大肌"], primaryMuscleGroup: .legs, movementPattern: .squat, isSystem: true),
            Exercise(name: "前蹲", nameEn: "Front Squat", categoryId: categoryId, type: .freeWeight, muscleGroups: ["股四頭肌"], primaryMuscleGroup: .legs, movementPattern: .squat, isSystem: true),
            Exercise(name: "硬舉", nameEn: "Deadlift", categoryId: categoryId, type: .freeWeight, muscleGroups: ["腿後肌", "臀部", "下背"], primaryMuscleGroup: .legs, movementPattern: .hinge, isSystem: true),
            Exercise(name: "羅馬尼亞硬舉", nameEn: "Romanian Deadlift", categoryId: categoryId, type: .freeWeight, muscleGroups: ["腿後肌", "臀部"], primaryMuscleGroup: .legs, movementPattern: .hinge, isSystem: true),
            Exercise(name: "腿推機", nameEn: "Leg Press", categoryId: categoryId, type: .machine, muscleGroups: ["股四頭肌", "臀大肌"], primaryMuscleGroup: .legs, movementPattern: .squat, isSystem: true),
            Exercise(name: "腿伸屈", nameEn: "Leg Extension", categoryId: categoryId, type: .machine, muscleGroups: ["股四頭肌"], primaryMuscleGroup: .legs, movementPattern: .isolation, isSystem: true),
            Exercise(name: "腿彎舉", nameEn: "Leg Curl", categoryId: categoryId, type: .machine, muscleGroups: ["腿後肌"], primaryMuscleGroup: .legs, movementPattern: .isolation, isSystem: true),
            Exercise(name: "保加利亞分腿蹲", nameEn: "Bulgarian Split Squat", categoryId: categoryId, type: .freeWeight, muscleGroups: ["股四頭肌", "臀大肌"], primaryMuscleGroup: .legs, movementPattern: .squat, isSystem: true),
            Exercise(name: "箭步蹲", nameEn: "Lunge", categoryId: categoryId, type: .freeWeight, muscleGroups: ["股四頭肌", "臀大肌"], primaryMuscleGroup: .legs, movementPattern: .squat, isSystem: true),
            Exercise(name: "臀推", nameEn: "Hip Thrust", categoryId: categoryId, type: .freeWeight, muscleGroups: ["臀大肌"], primaryMuscleGroup: .legs, movementPattern: .hinge, isSystem: true),
            Exercise(name: "提踵", nameEn: "Calf Raise", categoryId: categoryId, type: .freeWeight, muscleGroups: ["小腿"], primaryMuscleGroup: .legs, movementPattern: .isolation, isSystem: true),
            Exercise(name: "坐姿提踵", nameEn: "Seated Calf Raise", categoryId: categoryId, type: .machine, muscleGroups: ["小腿"], primaryMuscleGroup: .legs, movementPattern: .isolation, isSystem: true)
        ]
    }()
    ...
    static let shoulderExercises: [Exercise] = {
        ...
        return [
            Exercise(name: "肩推", nameEn: "Overhead Press", categoryId: categoryId, type: .freeWeight, muscleGroups: ["三角肌", "肱三頭肌"], primaryMuscleGroup: .shoulders, movementPattern: .push, isSystem: true),
            Exercise(name: "啞鈴肩推", nameEn: "Dumbbell Shoulder Press", categoryId: categoryId, type: .freeWeight, muscleGroups: ["三角肌"], primaryMuscleGroup: .shoulders, movementPattern: .push, isSystem: true),
            Exercise(name: "阿諾推舉", nameEn: "Arnold Press", categoryId: categoryId, type: .freeWeight, muscleGroups: ["三角肌"], primaryMuscleGroup: .shoulders, movementPattern: .push, isSystem: true),
            Exercise(name: "側平舉", nameEn: "Lateral Raise", categoryId: categoryId, type: .freeWeight, muscleGroups: ["三角肌中束"], primaryMuscleGroup: .shoulders, movementPattern: .isolation, isSystem: true),
            Exercise(name: "前平舉", nameEn: "Front Raise", categoryId: categoryId, type: .freeWeight, muscleGroups: ["三角肌前束"], primaryMuscleGroup: .shoulders, movementPattern: .isolation, isSystem: true),
            Exercise(name: "俯身側平舉", nameEn: "Bent-Over Lateral Raise", categoryId: categoryId, type: .freeWeight, muscleGroups: ["三角肌後束"], primaryMuscleGroup: .shoulders, movementPattern: .isolation, isSystem: true),
            Exercise(name: "直立划船", nameEn: "Upright Row", categoryId: categoryId, type: .freeWeight, muscleGroups: ["三角肌", "斜方肌"], primaryMuscleGroup: .shoulders, movementPattern: .pull, isSystem: true),
            Exercise(name: "肩推機", nameEn: "Shoulder Press Machine", categoryId: categoryId, type: .machine, muscleGroups: ["三角肌"], primaryMuscleGroup: .shoulders, movementPattern: .push, isSystem: true),
            Exercise(name: "Cable 側平舉", nameEn: "Cable Lateral Raise", categoryId: categoryId, type: .machine, muscleGroups: ["三角肌中束"], primaryMuscleGroup: .shoulders, movementPattern: .isolation, isSystem: true),
            Exercise(name: "臉拉", nameEn: "Face Pull", categoryId: categoryId, type: .machine, muscleGroups: ["三角肌後束"], primaryMuscleGroup: .shoulders, movementPattern: .pull, isSystem: true)
        ]
    }()
    ...
    static let armExercises: [Exercise] = {
        ...
        return [
            Exercise(name: "槓鈴彎舉", nameEn: "Barbell Curl", categoryId: categoryId, type: .freeWeight, muscleGroups: ["二頭肌"], primaryMuscleGroup: .arms, movementPattern: .pull, isSystem: true),
            Exercise(name: "啞鈴彎舉", nameEn: "Dumbbell Curl", categoryId: categoryId, type: .freeWeight, muscleGroups: ["二頭肌"], primaryMuscleGroup: .arms, movementPattern: .pull, isSystem: true),
            Exercise(name: "錘式彎舉", nameEn: "Hammer Curl", categoryId: categoryId, type: .freeWeight, muscleGroups: ["二頭肌", "前臂"], primaryMuscleGroup: .arms, movementPattern: .pull, isSystem: true),
            Exercise(name: "集中彎舉", nameEn: "Concentration Curl", categoryId: categoryId, type: .freeWeight, muscleGroups: ["二頭肌"], primaryMuscleGroup: .arms, movementPattern: .isolation, isSystem: true),
            Exercise(name: "三頭下壓", nameEn: "Tricep Pushdown", categoryId: categoryId, type: .machine, muscleGroups: ["肱三頭肌"], primaryMuscleGroup: .arms, movementPattern: .push, isSystem: true),
            Exercise(name: "過頭三頭伸展", nameEn: "Overhead Tricep Extension", categoryId: categoryId, type: .freeWeight, muscleGroups: ["肱三頭肌"], primaryMuscleGroup: .arms, movementPattern: .isolation, isSystem: true),
            Exercise(name: "窄握臥推", nameEn: "Close-Grip Bench Press", categoryId: categoryId, type: .freeWeight, muscleGroups: ["肱三頭肌", "胸部"], primaryMuscleGroup: .arms, movementPattern: .push, isSystem: true),
            Exercise(name: "啞鈴三頭後踢", nameEn: "Tricep Kickback", categoryId: categoryId, type: .freeWeight, muscleGroups: ["肱三頭肌"], primaryMuscleGroup: .arms, movementPattern: .isolation, isSystem: true),
            Exercise(name: "Cable 彎舉", nameEn: "Cable Curl", categoryId: categoryId, type: .machine, muscleGroups: ["二頭肌"], primaryMuscleGroup: .arms, movementPattern: .pull, isSystem: true),
            Exercise(name: "EZ Bar 彎舉", nameEn: "EZ Bar Curl", categoryId: categoryId, type: .freeWeight, muscleGroups: ["二頭肌"], primaryMuscleGroup: .arms, movementPattern: .pull, isSystem: true),
            Exercise(name: "反握彎舉", nameEn: "Reverse Curl", categoryId: categoryId, type: .freeWeight, muscleGroups: ["前臂", "二頭肌"], primaryMuscleGroup: .arms, movementPattern: .pull, isSystem: true)
        ]
    }()
    ...
    static let coreExercises: [Exercise] = {
        ...
        return [
            Exercise(name: "捲腹", nameEn: "Crunch", categoryId: categoryId, type: .bodyweight, muscleGroups: ["腹直肌"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "仰臥起坐", nameEn: "Sit-up", categoryId: categoryId, type: .bodyweight, muscleGroups: ["腹直肌"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "棒式", nameEn: "Plank", categoryId: categoryId, type: .bodyweight, muscleGroups: ["核心"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "側棒式", nameEn: "Side Plank", categoryId: categoryId, type: .bodyweight, muscleGroups: ["腹斜肌"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "懸吊舉腿", nameEn: "Hanging Leg Raise", categoryId: categoryId, type: .bodyweight, muscleGroups: ["下腹"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "捲腹機", nameEn: "Ab Crunch Machine", categoryId: categoryId, type: .machine, muscleGroups: ["腹直肌"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "Cable 捲腹", nameEn: "Cable Crunch", categoryId: categoryId, type: .machine, muscleGroups: ["腹直肌"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "Russian Twist", nameEn: "Russian Twist", categoryId: categoryId, type: .bodyweight, muscleGroups: ["腹斜肌"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "登山者式", nameEn: "Mountain Climber", categoryId: categoryId, type: .bodyweight, muscleGroups: ["核心"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true),
            Exercise(name: "腹輪", nameEn: "Ab Wheel", categoryId: categoryId, type: .bodyweight, muscleGroups: ["核心"], primaryMuscleGroup: .core, movementPattern: .isolation, isSystem: true)
        ]
    }()
